...
baseBasico <- readxl::read_excel("data/similaridade/baseModelo1.xlsx")|>
...
kgeral <- rbind(kgeralBas, kgeralSec, kgeralSecpr)
  # writexl::write_xlsx(kgeral, "data/similaridade/kGeral.xlsx")
  # writexl::write_xlsx(ClusterMeansGeral1719, "data/similaridade/ClusterMeansGeral1719.xlsx")


# scatterplot3d(base$equidade,  xlab = "Ìndice de Equidade",
